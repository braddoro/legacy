...
<td>
<%
RESPONSE.write "<h2>Committee Meeting Minutes</h2><br><br>"
...
response.write"</table>"	
%>
<FORM method="post" encType="multipart/form-data" action="upload\ToFileSystem.asp">
<table>
<tr>
<td>File Name</td>
