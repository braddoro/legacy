...
<td>
<%
	RESPONSE.write "<h2>Maps</h2><br><br>"
	Response.write "<h4>Here are some maps to our favorite places</h4><br><br>"
    	'File System Object
    	dim objFSO
    	'File Object
    	dim objFile
		...
		sMapPath = "c:\webdirs\Troop18\Maps\"
    	...
    	For Each objFile in objFolder.Files
				...
				response.Write "<img src='/maps/" & objFile.Name & "' alt='" & objFile.Name & "' border='0' align='left'>"
				response.write "</td></tr>"
				response.write "</tr><td>"  & lcase(objFile.Name) & " - " & objFile.DateLastModified & "</td></tr>"
