...
<td>
<%
RESPONSE.write "<h2>Page Logs</h2><br><br>"
str_SQL = "SELECT PageLogs.AddedDate, PageNames.PageName, PageLogs.IPAddress FROM PageNames INNER JOIN PageLogs ON PageNames.PageNameID = PageLogs.PageNameID_fk WHERE (((PageLogs.AddedDate)>Now()-14)) ORDER BY PageLogs.AddedDate DESC;"
...
Do while not obj_RecordSet.eof
	...
	response.write "</td>"
	response.write "<td>"
	response.write	obj_RecordSet("PageName")
	response.write "</td>"
	response.write "<td>"
	response.write	obj_RecordSet("IPAddress")
	response.write "</td>"
	response.write "</tr>"
	obj_RecordSet.movenext
loop
