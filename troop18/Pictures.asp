...
<td>
<%
	RESPONSE.write "<h2>Pictures</h2><br><br>"
	response.write "<br><h4>Some of our favorite pictures</h4><br><br>"
    	'File System Object
    	dim objFSO
    	'File Object
    	dim objFile
    	...
    	For Each objFile in objFolder.Files
				...
				response.Write "<img src='/pictures/" & objFile.Name & "' alt='" & objFile.Name & "' border='0' align='left'>"
