...
' Print the header
'----------------------------------------------------------------------------------------
response.write "<font face=arial color='gold'><h2>Troop 18 Calendar</h2></font>"
...
str_SQL = "SELECT ActivityID, ActivityStart, ActivityType, " & _
		...
		"and Activities.Active = 'Y' ORDER BY Activities.ActivityStart;"
...
CloseCalendar
%>
<img src="images/sq-rope.gif" alt="" width="580" height="25" border="0"><br>